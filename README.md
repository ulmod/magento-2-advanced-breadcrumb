...
[Magento 2 Advanced Breadcrumbs](https://www.ulmod.com/magento-2-advanced-breadcrumb-extension.html)  is a Magento 2 extension that helps search engines and visitors better navigate through your website.

With Magento 2 Advanced Breadcrumbs, you can choose to show shortest or longest breadcrumbs navigation paths on product pages, and add breadcrumbs to the pages that do not have breadcrumbs by default in Magento 2.


<a href="https://www.ulmod.com/magento-2-advanced-breadcrumb-extension.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Ability to use shortest or longest breadcrumbs navigation paths on product pages 
* Ability to choose the categories to use in breadcrumbs for products that exist in multiple categories
* Support structured data (rich snippets) for breadcrumbs on product pages
* Permanently add category path to the product page breadcrumb, whether the shoppers
 accesses the product page from any page of the site or the search engine
* Adds breadcrumbs on compare product, wishlist index, and wishlist share pages
* Adds breadcrumbs on customer account pages, such as confirmation, review index,
 review view, billing agreement, edit book address, set password, edit information, view book address, downloadable, 
 store payment method, sales order history, sales order view, and newsletter subscription pages
* Adds breadcrumbs to the cart, checkout index, and checkout success pages
* Support multi-stores

<img src="https://www.ulmod.com/media/ulmod/product_content/umadvbread-prod.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umadvbread-addi.png">
